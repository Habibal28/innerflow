          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>New Trabar & Anabar</h4>
              </div>
              <?php echo form_open_multipart(base_url('Administrator/addTrabarAnabar/'), 'class="form-horizontal"');  ?>
              <div class="card-body float-left">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-12">
                    <textarea name="content" id="content" class="summernote-simple w-100" required></textarea>
                  </div>
                </div>
                <div class="form-group row mb-4">
