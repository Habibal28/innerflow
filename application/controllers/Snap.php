...
class Snap extends CI_Controller {
    ...
    public function finish()
    {
		...
		$gross_amount = str_replace('.00','',$result->gross_amount); //menghilangkan angka dibelekang koma
		$data = [
		...
		$this->M_snap->tambahPembayaran($data);
		redirect('Midtrans/cekstatus/'.$data['order_id']);
